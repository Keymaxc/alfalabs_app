...
@section('content')
    ...
    <div class="card">
        <div class="card-body py-4">
            ...
            {{-- Bar atas: search + filter status + link ke halaman selesai --}}
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                <form
                    action="{{ route('pengerjaan.berjalan') }}"
                    method="GET"
                ...
                {{-- Tombol ke halaman selesai --}}
                <a href="{{ route('pengerjaan.selesai') }}"
                   class="btn btn-outline-secondary btn-rounded px-3">
                    <i class="fas fa-check-circle me-1"></i> Lihat yang Selesai
                </a>
            </div>
            ...
            <div class="table-responsive">
                <table id="tabel-pengerjaan" class="table table-hover table-sm align-middle mb-0">
                    ...
                    <tbody>
                                            ...
                                            <div class="modal-body" style="font-size: 0.85rem;">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea
                                                        ...
                                                        rows="3"
                                                        class="form-control"
                                                        placeholder="Contoh: Sudah dicuci dan disetrika."
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center">Belum ada pengerjaan berjalan.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
